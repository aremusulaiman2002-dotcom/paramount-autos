                ...
                <div className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex justify-between items-center py-2 border-b border-orange-200">
                      ...
                      <span className="font-semibold text-orange-900 text-sm sm:text-base text-right">First Bank</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-orange-200">
                      <span className="text-orange-800 font-medium text-sm sm:text-base">Account Name:</span>
                      <span className="font-semibold text-orange-900 text-sm sm:text-base text-right">Paramount Autos</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-orange-200">
                      <span className="text-orange-800 font-medium text-sm sm:text-base">Account Number:</span>
                      <span className="font-semibold text-orange-900 text-sm sm:text-base">1234567890</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-orange-200">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-blue-700 text-xs sm:text-sm">Transfer using provided bank details</div>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-bold mt-0.5 flex-shrink-0">
                      ...
                      <div>
                        ...
                        <div className="text-blue-700 text-xs sm:text-sm">Email receipt to payments@paramountautos.com</div>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-sm font-bold mt-0.5 flex-shrink-0">
                      ...
                      <div>
                        ...
                        <div className="text-blue-700 text-xs sm:text-sm">Confirmed within 2 hours of payment</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                  ...
                  <div className="space-y-2 sm:space-y-3 text-gray-700">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-orange-600 font-semibold text-sm sm:text-base">+234 800 000 0000</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="font-medium text-sm sm:text-base">Email:</span>
                      <span className="text-orange-600 font-semibold text-xs sm:text-sm break-all text-right">support@paramountautos.com</span>
                    </div>
                    <div className="flex justify-between items-center">
